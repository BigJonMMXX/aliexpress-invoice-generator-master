...
(function() {
  ...
  function addButtons() {
    ...
    const lastButtonSelector = '.order-status button:last-of-type'
  ...
  function addMessageContainer() {
    let parent = document.querySelector('.order-status');
    if (!parent) {
  ...
  function getProductTotal() {
    ...
    let element = getNthElement(document, 'div.order-price-item', 0, 'product total', SEVERITY_ERROR);
  ...
  function getShippingTotal() {
    ...
    let element = getNthElement(document, 'div.order-price-item', 1, 'shipping total', SEVERITY_ERROR);
    return element ? normalizePrice(element.textContent) : null
  }
  ...
  function getTotal(hasTax) {
    ...
    let element = getNthElement(document, 'div.order-price-item', hasTax ? 3 : 2, 'total', SEVERITY_ERROR);
    return element ? normalizePrice(element.textContent) : null
  }
